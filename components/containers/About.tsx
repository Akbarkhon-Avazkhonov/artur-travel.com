...
import shape from "@/public/images/about/dot-shape.png";
import one from "@/public/images/about/03.jpg";
import three from "@/public/images/about/group.png";

const About = () => {
  return (
    <section className="about-section section-padding sect-bg">
          ...
          <div className="row g-4 align-items-center">
            <div className="col-lg-5">
              <div className="about-image wow img-custom-anim-left">
                <Image src={"https://www.responsiblevacation.com/imagesClient/S_294569.jpg"} alt="img"  width={500} height={400}/>
                <div className="about-box float-bob-y">
                  <h2 className="odo-wrap">
                    <Counter value={29} />+
                  </h2>
            ...
            <div className="col-lg-7">
              <div className="about-content">
                ...
                >
                  ...
                  attraction pass save you more than buying individual tickets
                  for your tour package system.
                </p>
                <div
                  className="about-sideber "
                  data-aos-duration="800"
                  data-aos="fade-up"
                  data-aos-delay="160"
                >
  ...
  <p style={{ margin: 0, fontSize: '0.9rem', color: '#666' }}>— Simon Raven</p>
</div>
                ...
                <div className="about-btn">
                  <Link
                    href="https://www.trip.com/?Allianceid=6096497&SID=240678523&trip_sub1=&trip_sub3=D4556848"
                    className="theme-btn "
                    data-aos-duration="800"
                    data-aos="fade-up"
                    data-aos-delay="100"
