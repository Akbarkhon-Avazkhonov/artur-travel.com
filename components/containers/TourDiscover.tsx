...
const TourDiscover = () => {
  return (
    <section
      ...
      style={{
        backgroundImage: "url(https://www.responsiblevacation.com/imagesClient/S_294569.jpg)",
      }}
    >
              ...
              <div className="tour-content lg-center">
                <div className="section-title">
                  ...
                  <p
                    ...
                    data-aos-delay="500"
                  >
                    Curated destinations and tours that capture the true <br />{" "}
                    essence of location, ensuring you experience. Our <br />{" "}
                    attraction pass save you more.
                  </p>
                </div>
                        ...
                        <div className="swiper-slide">
                          <div className="tour-card-item">
                            ...
                            <div className="tour-content">
                              <h6>
                                From <span>${item.price}</span> ${item.discount}
                              </h6>
                              <h4>
